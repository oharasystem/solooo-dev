...
import { ScreenshotProvider, MainScreenshot, GalleryScreenshots } from '@/components/ScreenshotGallery';
            ...
            <div className="space-y-8 text-center flex flex-col items-center">
              ...
              <div className="pt-8 flex justify-center w-full">
                <Link
                  ...
                  className="inline-flex items-center justify-center px-6 sm:px-12 md:px-16 py-4 text-base sm:text-lg font-bold text-white bg-blue-900 rounded-2xl hover:bg-blue-800 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 w-full sm:w-auto whitespace-nowrap"
                >
                  プロダクトページへ
        ...
        <section className="space-y-24 py-12">
          ...
          <div className="flex flex-col items-center gap-8 pt-12 border-t border-slate-100">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-8 sm:px-12 py-4 sm:py-5 text-lg sm:text-xl font-bold text-white bg-blue-900 rounded-2xl hover:bg-blue-800 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 w-full sm:w-auto whitespace-nowrap"
            >
              プロダクトページへ
              <svg className="w-5 sm:w-6 h-5 sm:h-6 ml-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
              </svg>
            </Link>
          </div>
